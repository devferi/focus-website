      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
          <div className="flex h-full flex-col">
            ...
            <div className="mt-6 lg:mt-auto grid sm:grid-cols-2 gap-4 items-stretch">
          ...
          <div className="rounded-[32px] bg-brand-dark text-white p-8 shadow-soft relative overflow-hidden h-full">
            ...
            <div className="relative">
              <p className="text-sm uppercase tracking-[0.3em] text-white/70 font-extrabold">Vision & Mission</p>
              <div className="mt-5 space-y-5 text-sm text-white/80">
                <div>
                  <p className="text-xs uppercase tracking-[0.4em] text-white/60 font-black">VISION</p>
                ...
                <div>
                  <p className="text-xs uppercase tracking-[0.4em] text-white/60 font-black">MISSION</p>
